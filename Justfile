...
doctor:
    @echo "Running diagnostics for methodologies..."
...
heal:
    @echo "Attempting auto-repair for methodologies..."
...
help-me:
    @echo "=== methodologies Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/methodologies/issues/new"
    @echo ""
