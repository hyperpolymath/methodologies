...
// Replace methodologies, Methodologies — See README.adoc for details., just run, Methodologies started successfully. with actuals
= methodologies — Quick Start for Users
:toc:
:toclevels: 2

== What is methodologies?

Methodologies — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./methodologies-portable
----
...
[source]
----
Methodologies started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/methodologies/wiki
